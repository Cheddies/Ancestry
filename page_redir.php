...
if($url == 'productdetail.php'){
	if(isset($_GET['number'])){
		...
		switch($number){
			...
			break;
			case 'FTMPLATINUM2009': $newPage = WEBROOT . 'products/software/family-tree-maker-2009-deluxe-edition';
			break;
			case 'GIFTPACK': $newPage = WEBROOT . 'products/gifts/ancestry-co-uk-membership-gift-pack';
			break;
			case 'FTMDELUXE2009': $newPage = WEBROOT . 'products/software/family-tree-maker-2009-deluxe-edition';
			break;
			case 'FTMPLATINUM2011': $newPage = WEBROOT . 'products/software';
			break;			
		}		
	}	
}
...
if(!$newpage){
	switch($url){
		case 'surname_book.php': $newPage = WEBROOT . 'products/books/surname-book-your-name-in-history';
		break;
		case 'freeupgrade': $newPage = WEBROOT;
		break;
		...
		break;
		case 'products': $newPage = WEBROOT . 'products/software';
		break;
		case 'ftm': $newPage = WEBROOT . 'products/software/family-tree-maker-2010-platinum-edition';
		break;
	}
}
