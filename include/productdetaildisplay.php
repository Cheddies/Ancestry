...
<?php
	...
	{ 
		$query = "SELECT tbl_products.expectdate,tbl_products.number, tbl_products.inetsdesc,tbl_products.inetshortd, tbl_products.price, tbl_products.compareprice, tbl_products.inetfdesc, tbl_products.inetimage, tbl_products.relateditems, tbl_products.mastersub ,tbl_products.units,presell,tbl_products_departments.deptcode FROM tbl_products LEFT JOIN tbl_products_departments on tbl_products.number=tbl_products_departments.number WHERE number = '{$mysql['productupc']}'";
	}
	else
	{
...
<? if($line['deptcode'] == "1" || $line['deptcode'] == "7" || $line['deptcode'] == "8") {
echo "FREE NATIONAL TRUST CREAM TEA VOUCHER WITH PURCHASE*";
} ?>
<div id="product_desc">
