...
<!--[if !(IE)]><!--> <div id="mainContent" class="singleProductContainer"  style="width:920px;"> <!--<![endif]-->
    <div id="productBanner" class="clearfix">
        ...
        <div class="productInfo" style="width:540px;">
        	...
        	<p><strong>Family Tree Maker will no longer be offered as of 31st December 2015</strong></p>
            <?php
	        ...
	        ?>
	        <!--<a href="<?php echo WEBROOT;?>addtobasket.php?code=<?php echo $product['number'];?>" id="shipBtn" class="shipBtn ancBtn orange lrg"><span></span><em>Ship It</em><span></span></a>-->
	        <a href="https://shop.avanquest.com/store2/ancestry_transition.php?i=9974556&preflanguage=1&rs2=AQ_UK_DTC_ANCESTRYUK&rs4=DTC_ANCESTRYUK" id="downloadBtn" class="downloadBtn ancBtn orange lrg"><span></span><em>Download</em><span></span></a>
	        <?php	
        	}
	        ...
	        ?>
	        <!--<a href="<?php echo WEBROOT;?>addtobasket.php?code=<?php echo $product['number'];?>" id="shipBtn" class="shipBtn ancBtn orange lrg"><span></span><em>Ship It</em><span></span></a>-->
	        <a href="https://shop.avanquest.com/store2/ancestry_transition.php?i=9974554&preflanguage=1&rs2=AQ_UK_DTC_ANCESTRYUK&rs4=DTC_ANCESTRYUK" id="downloadBtn" class="downloadBtn ancBtn orange lrg"><span></span><em>Download</em><span></span></a>
	        <?php	
        	}
	        ...
	        ?>
	        <!--<a href="<?php echo WEBROOT;?>addtobasket.php?code=<?php echo $product['number'];?>" id="shipBtn" class="shipBtn ancBtn orange lrg"><span></span><em>Ship It</em><span></span></a>>-->
	        <a href="https://shop.avanquest.com/store2/ancestry_transition.php?i=9974557&preflanguage=1&rs2=AQ_UK_DTC_ANCESTRYUK&rs4=DTC_ANCESTRYUK" id="downloadBtn" class="downloadBtn ancBtn orange lrg"><span></span><em>Download</em><span></span></a
	        <?php	
        	}
        	else{
	        ?>
    ...
    <div id="tabContainer">
		...
		<!--<div class="ftmVideoThumb" title="Family Tree Maker 2012 - Video(1:27)" style="clear:none; width:380px; height:230px; margin-top:2em;"><img src="../../landing/files/ftm_video_thumb.jpg" /></div>
        	...
        	<div class="tabContent reqTab" style="display: none; ">
                ...
                <ul>
                	<li>Windows&reg; 7 (32-bit or 64-bit) or Windows&reg; 8 (32-bit or 64-bit)</li>
