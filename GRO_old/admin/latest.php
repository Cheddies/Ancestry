...
$query7 = "SELECT count(GRO_orders_id) as numorders, SUM(total_paid) as paid FROM GRO_orders WHERE authorised = 1 and order_date = '" . $seven . "' GROUP BY order_date;";
$query8 = "SELECT count(GRO_orders_id) as numorders, SUM(total_paid) as paid FROM GRO_orders WHERE authorised = 1 and order_date = '" . $eight . "' GROUP BY order_date;";
$query9 = "SELECT count(GRO_orders_id) as numorders, SUM(total_paid) as paid FROM GRO_orders WHERE authorised = 1 and order_date = '" . $nine . "' GROUP BY order_date;";
$query10 = "SELECT count(GRO_orders_id) as numorders, SUM(total_paid) as paid FROM GRO_orders WHERE authorised = 1 and order_date = '" . $ten . "' GROUP BY order_date;";
$query11 = "SELECT count(GRO_orders_id) as numorders, SUM(total_paid) as paid FROM GRO_orders WHERE authorised = 1 and order_date = '" . $eleven . "' GROUP BY order_date;";
$query12 = "SELECT count(GRO_orders_id) as numorders, SUM(total_paid) as paid FROM GRO_orders WHERE authorised = 1 and order_date = '" . $twelve . "' GROUP BY order_date;";
