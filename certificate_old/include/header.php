<?php
	...
	//stop order_summary page being cached at all
	//added 11-03-09
...
<head>
	...
	<?php
		...
		if(isset($Page))
		{	
			//edit due to changes in the way meta tags/breadcrumbs work on main site
			//set variable when looking up index page 
			if($Page=="index")
...
<div id="container">
<div id="main_top_bar">
	 <a href="faqs.php">Certificate FAQs</a>
</div>
<div id="logo_section">
...
<div id="info_message">
	Exciting News - Birth, Marriage and Death certificates forms will soon be made simpler for your convenience.
</div>