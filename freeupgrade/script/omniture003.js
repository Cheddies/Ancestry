/* SiteCatalyst code version: H.11.  TGN version 003
Copyright 1997-2007 Omniture, Inc.
Portions Copyright 2004-2007, The Generations Network */
/* Specify the Report Suite ID(s) to track here */
if((document.location.hostname.indexOf("trydev")!=-1)||(document.location.hostname.indexOf("trystage")!=-1)||(document.location.hostname.indexOf("aoltest")!=-1) )
	s_account='devancestry';
if(typeof(s_account)=='undefined')
	var s_account="myfamilyancestry";
var s=s_gi(s_account,1)
var s_visitorSampling,s_visitorSamplingGroup;
s.visitorSampling = s_visitorSampling; //070926-000105 - roll sampling fix on month boundary
s.visitorSamplingGroup = s_visitorSamplingGroup;
/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
s.charSet="UTF-8"
if(typeof(s.server)=='undefined')
	s.server=window.document.location.hostname;
if((typeof s.channel)=='undefined')
	s.channel='0000';//Anc
if(document.location.hostname.indexOf(".co.")!=-1)
	s.cookieDomainPeriods=3;
/* Conversion Config */
if(typeof(s.currencyCode)=='undefined')s.currencyCode="USD";
/* Link Tracking Config */
s.trackDownloadLinks=false
s.trackExternalLinks=false
s.trackInlineStats=true
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls"
s.linkInternalFilters="javascript:,ancestry.aol.com/,ancestry.myfamily.com/,ancestry.netscape.com/,ancestry.com/,ancestry.co.uk/,ancestry.custhelp.com/,ancestryaol.com/,ancestry.families.aol.com/,enetwizard.com/,ancestry.compuserve.com/,ancestryfamilytree.com/,ancestry.hometown.aol.com/,ancestry.com,//ancestry.com,ancestry.com./,ancestry.com./Default.aspx,landing.ancestry.com,www.ancestry.com,www.ancestry.com./,www.ancestry.com/,www.ancestry.com./Default.aspx,www.ancestry.com.,ancestry.com\,trees.ancestry.com,trees.ancestry.com:80,ancboards.ancestry.com,ancboards.ancestry.com:80,boards.ancestry.com,ancestry.netscape.com"
s.linkLeaveQueryString=false
if(typeof(s.linkTrackVars)=='undefined')s.linkTrackVars="None";
if(typeof(s.linkTrackEvents)=='undefined')s.linkTrackEvents="None";
/************************** ANCESTRY SECTION ************************/
//o_xid - querystring indicating external source id
//o_iid - querystring indicating internal source id
//o_lid - querystring indicating source id, whether in. or ext.
//s_eVar19_Not - js var expected on signup & purchase pages
function o_QueryString(k){
	var qs=window.location.search+'';
	var s=qs.replace(new RegExp("^.*[&?]"+k+"=([^&?]+).*$","i"),"$1");
	return s==qs?"":s;}
function o_Cookie(n){
	var c=" "+document.cookie;
	var v=c.match(new RegExp(" "+n+"=([^;]+)","i"));
	return v==null?"":unescape(RegExp.$1);}
var o_lid=o_QueryString("o_lid");
var o_did=o_QueryString("sssdmh");
if(!s.campaign)s.campaign=o_QueryString("o_xid");
//small to big:
if(!s.eVar4)s.eVar4=o_QueryString("o_iid");
if(!s.eVar13)s.eVar13=o_lid;
if(o_lid)s.eVar17="Last:XID/IID";
var s_eVar19_Not;
if(!s_eVar19_Not&&!s.eVar19&&document.location.href.indexOf("/subscribe/")<0&&document.location.href.indexOf("/SUBS/basket")<0)
	s.eVar19=s.pageName?s.pageName:document.location.pathname;
if(!s.eVar20&&(s.campaign||o_did))s.eVar20=s.pageName?s.pageName:document.location.pathname;
s.eVar23=(!o_did&&s.eVar4)?"Other IID":o_did;
/* WARNING: Changing anything below will cause drastic changes. Changes
should only be made when instructed to do so by your account manager.*/
s.dc=112
...
+"$V:112)+'.2o7.net')@ub/ss/'+^2+'/1/H.11-pdv-2/'+@Z+'?[AQB]&ndh=1'+("
...
+"ct`5@a`Gv0`5^J`Gx`5`t`Gc`5`h`Gj`5`W`Gv`5`m^n`Gk`5`q^m`Gbw`5`q^P`Gbh"
