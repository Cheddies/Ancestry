...
//	define ('DB_HOST',"78.31.106.175");
	...
	define ('DB_NAME',"ancestry");
	//LIVE Account define ('SECURE_TRADING_ACCOUNT','elmancestry11634');
	define ('SECURE_TRADING_ACCOUNT','test_elmancestry32377');
}
...
<?php
	...
	//old - requires a space 
	//define ('POSTCODE_REG_EX','^([A-PR-UWYZ0-9][A-HK-Y0-9][AEHMNPRTVXY0-9]?[ABEHMNPRVWXY0-9]? {1,2}[0-9][ABD-HJLN-UW-Z]{2}|GIR 0AA)$');
	define ('POSTCODE_REG_EX','^([Gg][Ii][Rr] 0[Aa]{2})|((([A-Za-z][0-9]{1,2})|(([A-Za-z][A-Ha-hJ-Yj-y][0-9]{1,2})|(([A-Za-z][0-9][A-Za-z])|([A-Za-z][A-Ha-hJ-Yj-y][0-9]?[A-Za-z])))) {0,1}[0-9][A-Za-z]{2})$');
