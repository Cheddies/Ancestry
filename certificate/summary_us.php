...
//only for US - changes ST to US mode, taking Zip code and  State
$locale="en_US";
...
<div id="bil_add_fields" class="add_fields">
	...
	<?php 
	//include the new ST form
	//it has the opening <form tag in it as well
	include ("include/new_st_form_bmd.php")
