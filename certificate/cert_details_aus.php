    ...
    <div id="content_wrapper" class="cert_details layout2 new_bmd">
		...
		<form action="upd_cert.php" method="post" class="shop_form">
			...
			<div class="col_a">
				...
				<fieldset class="info">
					<h2>This is our Australia store<br><img src="images/AUS.jpg"><br>If you are not in Australia, please select your country by clicking on the correct flag below</h2>
