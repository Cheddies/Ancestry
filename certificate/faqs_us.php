...
<p>
Due to the personalization of this service we can not cancel or amend an order once it has been placed
</p>
...
<p>Applications made after 1pm (UK Time) Monday to Friday will be treated as the next day's business.  This includes the express service.  Applications may be made at the weekend or on a UK bank holiday but will not be processed until the next working day.
</p>
<h3>How much does the service cost?</h3>
<ul>
	<li>Standard service - orders despatched up to 28 working days, $38 USD</li>
	<li>Express service - orders despatched up to 16 working days, $76 USD</li>
	<li>Standard international signed for service - order despatched up to 28 working days $47 USD</li>
	<li>Express international signed for service - order despatched up to 16 working days $85 USD</li>

	<li>Duplicate copies - Standard service $20 USD each. Express service $42 USD each</li>
	<li>Costs includes cost of certificate, handling charge, P&P</li>
</ul>
...
<p>
Please note that the certificate will be ready according to delivery service speed you have chosen and cannot be emailed beforehand. This is up to 28 working days for Standard and up to 16 working days for Express.
</p>
<p>
