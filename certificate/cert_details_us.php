...
<?php require_once('include/edgeward/new_bmd/header.inc.php'); ?>
    ...
    <div id="content_wrapper" class="cert_details layout2 new_bmd">
		...
		<form action="upd_cert.php" method="post" class="shop_form">
			...
			<div class="col_a">
				...
				<fieldset class="info">
					<h2>This is our USA store<br><img src="images/USA.jpg"><br>If you are not in the USA, please select your country by clicking on the correct flag below</h2>
	...
	<a href="https://www.ancestryshop.co.uk/certificate/index_ca.php" target="_blank"><img src="images/CAN-med.jpg" alt="Canada" border="0"/></a>
