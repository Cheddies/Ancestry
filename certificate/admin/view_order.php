...
//{
	...
	*/
	...
	switch($cert_ordered['certificate_type'])
	{
		...
		$labels=array("Year Birth Was Registered","Surname at Birth","Forenames","DOB","Place of Birth","Father's Surname","Father's Forename","Mother's Maiden Surname","Mother's Surname at Time of Birth","Mother's Forename(s)","Copies");
