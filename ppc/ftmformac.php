	...
	<div id="container">
		...
		<div id="content_wrapper" class="ftm_mac ftm">
			...
			<div id="intro_content">
				...
				<p>
                <a href="http://ancestryshop.co.uk/ftm2011" title="Buy Family Tree Maker PC version"><img src="<?php echo WWW_ROOT;?>images/layout/buy-ftm-pc.png"/></a>
                </p>
			...
			<div id="main_content">
				...
				<div id="tab_2" class="tab <?php if($tab != 2) echo inactive_tab ;?>">
					<div class="col_a firstcol">
						...
						<li>6-month Ancestry.co.uk&trade; Premium Membership* (worth over £77)</li>
						</ul>
						<div class="cta">
