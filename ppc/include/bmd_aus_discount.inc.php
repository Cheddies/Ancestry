		...
		<div id="content_wrapper" class="<?php echo $discount['code'] ? '' : 'std_page';?>">
			...
			<div id="main_content">
				...
				<div id="tab_2" class="tab <?php if($tab != 2) echo inactive_tab ;?>">
					<p>You can order a certificate as soon as you've found who you're looking for at Ancestry.com.au:</p>
					...
					<div class="cert_box">
						...
						<div class="col_b">
							<ul class="gallery">
								<li>
									<a href="<?php echo WWW_ROOT;?>images/promo/bmd2010/bmd1_l.jpg" class="prod_img" rel="tab2" title="You can order a certificate as soon as you've found who you're looking for at Ancestry.com.au"><img src="<?php echo WWW_ROOT;?>images/promo/bmd2010/bmd1.jpg"/></a>
								</li>
								<li>
