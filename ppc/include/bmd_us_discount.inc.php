		...
		<div id="content_wrapper" class="<?php echo $discount['code'] ? '' : 'std_page';?>">
			...
			<div id="main_content">
				...
				<div id="tab_1" class="tab <?php if($tab != 1) echo inactive_tab ;?>">					
					...
					<?php if($discount['code']) include('include/bmd_2010_terms_us.inc.php');?>
					
				</div><!-- end #tab_1-->
				
				<!-- tab 2-->
				<div id="tab_2" class="tab <?php if($tab != 2) echo inactive_tab ;?>">
					<p>You can order a certificate as soon as you've found who you're looking for at Ancestry.com:</p>
					...
					<div class="cert_box">
						...
						<div class="col_b">
							<ul class="gallery">
								<li>
									<a href="<?php echo WWW_ROOT;?>images/promo/bmd2011/bmd-us-search.jpg" class="prod_img" rel="tab2" title="You can order a certificate as soon as you've found who you're looking for at Ancestry.com"><img src="<?php echo WWW_ROOT;?>images/promo/bmd2011/bmd-us-search-thumb.jpg"/></a>
								</li>
								<li>
									<a href="<?php echo WWW_ROOT;?>images/promo/bmd2011/bmd-us-record.jpg" class="prod_img" rel="tab2" title="Once you've found the record of the person you want to discover more about, just click on the 'Order' button on the left under 'Page Tools'"><img src="<?php echo WWW_ROOT;?>images/promo/bmd2011/bmd-us-record-thumb.jpg"/></a>
								</li>
								<li>
									<a href="<?php echo WWW_ROOT;?>images/promo/bmd2011/bmd-us-checkout.jpg" class="prod_img" rel="tab2" title="We'll automatically fill in all the required information from the BMD Index for the record you've found"><img src="<?php echo WWW_ROOT;?>images/promo/bmd2011/bmd-us-checkout-thumb.jpg"/></a>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="cert_box">
						...
						<div class="col_b">
							<ul class="gallery">
								...
								<li>
									<a href="<?php echo WWW_ROOT;?>images/promo/bmd2011/bmd-us-record.jpg" class="prod_img" rel="tab3" title="To order a certificate, click on your chosen record, followed by the 'Order' button on the left under 'Page Tools'"><img src="<?php echo WWW_ROOT;?>images/promo/bmd2011/bmd-us-record-thumb.jpg"/></a>
								</li>
							</ul>
						</div>
					</div>
