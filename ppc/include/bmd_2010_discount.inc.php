	...
	<div id="container">
		...
		<div id="content_wrapper" class="<?php echo $discount['code'] ? '' : 'std_page';?>">
			...
			<div id="intro_content">
				<?php if($discount['code']):?><h3 class="order_today">Order today and save <span><?php echo $discount['amount'];?>%</span><span class="ast">*</span></h3><?php endif;?>
				...
				<p>Order birth, marriage and death certificates through the Ancestryshop – the quick, simple, affordable way to discover even more about your family history.
				</p>
				...
				<div class="pricing">
					...
					<p class="pricing"><?php if($discount['code']):?><span class="was">was <del><?php echo $curSymbol.$standardPrice;?></del></span> <?php endif;?><?php echo $curSymbol;?><?php echo $discount['std'];?></p>
				</div>
			...
			<div id="main_content">
				...
				<div id="tab_1" class="tab <?php if($tab != 1) echo inactive_tab ;?>">					
					...
					<p>With birth, marriage and death certificates you can discover a whole host of fascinating information that you won't be able to find anywhere else. Unmarried mothers, unknown fathers, unnatural deaths… There's so much waiting for you.</p>
					...
					<?php if($discount['code']) include('include/bmd_2010_terms.inc.php');?>
					
				</div><!-- end #tab_1-->
				
				<!-- tab 2-->
				<div id="tab_2" class="tab <?php if($tab != 2) echo inactive_tab ;?>">
					<p>You can order a certificate as soon as you've found who you're looking for at Ancestry.co.uk:</p>
					...
					<div class="cert_box">
						<div class="col_a">
							...
							<p class="note">Once you've ordered your certificate, you'll receive your paper copy within 16 working days – six days if you choose Express Delivery. </p>
						...
						<div class="col_b">
							<ul class="gallery">
								<li>
									<a href="<?php echo WWW_ROOT;?>images/promo/bmd2010/bmd1_l.jpg" class="prod_img" rel="tab2" title="You can order a certificate as soon as you've found who you're looking for at Ancestry.co.uk"><img src="<?php echo WWW_ROOT;?>images/promo/bmd2010/bmd1.jpg"/></a>
								</li>
								<li>
									<a href="<?php echo WWW_ROOT;?>images/promo/bmd2010/bmd2_l.jpg" class="prod_img" rel="tab2" title="Once you've found the record of the person you want to discover more about, just click on the 'Order' button on the left under 'Page Tools'"><img src="<?php echo WWW_ROOT;?>images/promo/bmd2010/bmd2.jpg"/></a>
								</li>
								<li>
									<a href="<?php echo WWW_ROOT;?>images/promo/bmd2010/bmd3_l.jpg" class="prod_img" rel="tab2" title="We'll automatically fill in all the required information from the BMD Index for the record you've found"><img src="<?php echo WWW_ROOT;?>images/promo/bmd2010/bmd3.jpg"/></a>
								</li>
							</ul>
						</div>
					</div>
				...
				<div id="tab_3" class="tab <?php if($tab != 3) echo inactive_tab ;?>">
					<p>If you've found your ancestors through our BMD Index records and have attached the record to your Ancestry family tree, you can order a certificate straight away – it's that quick and easy.</p>
					...
					<div class="cert_box">
						...
						<div class="col_b">
							<ul class="gallery">
								...
								<li>
									<a href="<?php echo WWW_ROOT;?>images/promo/bmd2010/bmd2_l.jpg" class="prod_img" rel="tab3" title="To order a certificate, click on your chosen record, followed by the 'Order' button on the left under 'Page Tools'"><img src="<?php echo WWW_ROOT;?>images/promo/bmd2010/bmd2.jpg"/></a>
								</li>
							</ul>
						</div>
					</div>
