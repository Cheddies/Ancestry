		...
		<div id="content_wrapper">
			<div id="intro_content">
				<div id="main_content">
					...
					<h2 class="main_title">Make more of your family research this Easter</h2>
					...
					<img src="<?php echo WWW_ROOT;?>images/layout/easter_photos.jpg" alt="Family Tree Maker 2010" id="header_photos"/>
