	...
	<div id="container">
		...
		<div id="content_wrapper" class="ftm2011 ftm">
			...
			<div id="intro_content">
				...
				<p><strong><a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTM2011A" title="Buy Family Tree Maker 2011 PLATINUM now">Don't miss out on this great offer, order today!</a></strong>
				</p>
				<a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTM2011A" class="big_buy_now btn"  title="Buy Family Tree Maker 2011 PLATINUM now">Buy now</a>
			...
			<div id="main_content">
				...
				<div id="tab_1" class="tab <?php if($tab != 1) echo inactive_tab ;?>">					
					<div class="col_a firstcol">
						...
						<p class="cta"><strong><a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTM2011A" title="Buy Family Tree Maker 2011 PLATINUM now">Don't miss out on this great offer, order now!</a></strong></p>
						<a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTM2011A" title="Buy Family Tree Maker 2011 PLATINUM now" class="buy_now btn"></a>
					</div>
				...
				<div id="tab_2" class="tab <?php if($tab != 2) echo inactive_tab ;?>">
					<div class="col_a firstcol">
						...
						<div class="cta">
							<p><strong><a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTM2011A" title="Buy Family Tree Maker 2011 PLATINUM now">Don't miss out on this great offer, order now!</a></strong></p>
							<a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTM2011A" title="Buy Family Tree Maker 2011 PLATINUM now" class="buy_now btn"></a>
						</div>
					</div>
					<div class="col_b">
