...
<body>
	<div id="container">
		...
		<div id="content_wrapper" class="ftm2011 ftm">
				
			<div id="intro_content">
				
				<p class="breadcrumb"><a href="http://AncestryShop.co.uk">AncestryShop</a> > Family Tree Maker</p>
				<h2 class="main_title">Get 25% off Family Tree Maker<span class="ast">&reg;</span> 2011 Platinum Edition<span class="ast">*</span></h2>
				...
				<p><strong><a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTMPPC11" title="Buy Family Tree Maker 2011 PLATINUM now">Don't miss out on this great offer, order today!</a></strong>
				</p>
                <p>
				<a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTMPPC11" class="big_buy_now btn"  title="Buy Family Tree Maker 2011 PLATINUM now">Buy now</a>
				</p>
				<p>
                <a href="http://ancestryshop.co.uk/ppc/ftmformac" title="Buy Family Tree Maker Mac version"><img src="<?php echo WWW_ROOT;?>images/layout/buy-ftm-mac.png"/></a>
                </p>
			...
			<div id="main_content">
				...
				<div id="tab_1" class="tab <?php if($tab != 1) echo inactive_tab ;?>">
					<div class="col_a firstcol">
						...
						<p class="lead_txt">Family Tree Maker® 2011 PLATINUM comes with 6 months of free* access to the UK's largest online collection of family history resources.</p>
						...
						<p class="cta"><strong><a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTMPPC11" title="Buy Family Tree Maker 2011 PLATINUM now">Don't miss out on this great offer, order now!</a></strong></p>
						<a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTMPPC11" title="Buy Family Tree Maker 2011 PLATINUM now" class="buy_now btn"></a>
					</div>
				...
				<div id="tab_2" class="tab <?php if($tab != 2) echo inactive_tab ;?>">
					<div class="col_a firstcol">
						...
						<div class="cta">
							<p><strong><a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTMPPC11" title="Buy Family Tree Maker 2011 PLATINUM now">Don't miss out on this great offer, order now!</a></strong></p>
							<a href="<?php echo WWW_ROOT;?>addtobasket.php?code=FTMPLATINUM2011&oc=FTMPPC11" title="Buy Family Tree Maker 2011 PLATINUM now" class="buy_now btn"></a>
						</div>
					</div>
					<div class="col_b">
