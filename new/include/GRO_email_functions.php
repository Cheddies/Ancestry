...
//need to populate cert_text/cert_html with the certificate details
	...
	<td><p><strong>Dear ". $billing_address['first_name'] .",</strong></p>
          ...
          <p>Please note that this email is confirmation receipt of your order .  Unfortunately due to the personalisation of this service we can not cancel or amend an order once it has been placed. {$contact_line}</p></td>
      </tr>
    </table></td>
  </tr>
  <tr>
