<?php include ('include/header.php');?>
	...
	<div id="content_wrapper" class="grid_12 alpha omega">
		<div id="page_content" class="grid_12">
			...
			<strong>
			This Privacy Statement was last updated on 14 Oct 2009.
			...
			<p>
			Ancestry.com Operations, Inc., and Ancestry.com UK (Commerce) Limited ("Ancestry", "we", "us" or "our")  are Data Controllers for the purposes of the Data Protection Act 1998 and we will use the data on your behalf for the purposes as set out below.
			</p>
			<p>
			...
			<p>
			As our business continues to grow, we might buy or sell subsidiaries or business units. In these transactions, customer information is often one of the transferred assets, remaining subject to promises made in existing privacy statements. Also, in the event that Ancestry.com Operations, Inc., Ancestry.com UK (Commerce) Limited or substantially all of their assets are acquired, customer information will as a matter of course be one of the transferred assets.
			</p>
