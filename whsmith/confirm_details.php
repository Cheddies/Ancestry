...
if(isset($_SESSION['dpwhsmith']))
	$clean['dpwhsmith']=form_clean($_POST['dpwhsmith'],1);*/
...
$mysql['whsmith_noemail']=mysql_real_escape_string($whsmith_noemail,$link);
...
if(isset($_SESSION['niceodrnum']))
{
	...
	$query = "UPDATE tbl_order_header_whsmith
		      ...
		      whsmith_noemail ='{$mysql['whsmith_noemail']}'
		      WHERE niceordernum={$mysql['niceodrnum']};";
}
else
{
	$query = "INSERT INTO tbl_order_header_whsmith
			  SET ordernumber = '" . $mysql['session_id'] . "',
			  order_date = '" . $mysql['orderdate'] . "',
			  firstname = '" . mysql_clean($_SESSION['c_name'], 15,$link) . "',
			  lastname = '" . mysql_clean($_SESSION['c_sname'], 20,$link) . "',
...
$query = "SELECT niceordernum FROM tbl_order_header_whsmith WHERE ordernumber = '{$mysql['session']}';";
...
<div class="checkout_box full">
	...
	<br />
	Click 'Continue' to complete the registration proccess.
	</p>
</div>
