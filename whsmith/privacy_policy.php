...
<strong>
This Privacy Statement was last updated on 29 May 2008.
...
<p>
Privacy Information for Ancestry.co.uk and Ancestryshop.co.uk
</p>

<h3>Overview</h3>

<p>
The Generations Network, Inc., and The Generations Network (Commerce) Limited ("Ancestry", "we", "us" or "our")  are Data Controllers for the purposes of the Data Protection Act 1998 and we will use the data on your behalf for the purposes as set out below.
</p>
<p>
The specifics of our Privacy Statement are best described in the answers to the following Frequently Asked Questions:
</p>
<h4>Does Ancestry ask for personal information?</h4>
<p>
Yes. Ancestry asks for your name and e-mail address, when you sign up as a member and use features such as e-mail. Registration as a user of or subscriber to the ancestry.co.uk Internet service results in your customer information being stored and processed in the United States, and you, in registering or subscribing, specifically consent to that storage and processing. Most of this information may be entered at your discretion. As a member of Ancestry, you can also choose to share further information about yourself, your background and interests with other members,  The amount and type of the profile information you share in this way is entirely your choice. See 'Member Profiles' below for more information on how you can edit or control what you allow other members to see about you in your public profile.
</p>
<p>
In addition we will need to know your postal address and payment details when you choose to take out a subscription with us or make purchases at the Ancestry Shop. We may also use the personal information you have provided for making purchases at the Ancestry Shop for marketing purposes, which may also be stored and processed in the United States, and you, in making a purchase from the Ancestry Shop consent to that storage and processing.   We may ask for similar information at other times, such as when you enter sweepstakes or other promotions sponsored by Ancestry and/or our many partners. 
</p>
<h4>How Does Ancestry use my personal information?</h4>
<p>
...
<p>
In distributing advertiser or sponsor messages, <strong>the advertiser never has access to individual account information. Ancestry does not sell, rent or otherwise distribute the personal information you provide us to these advertisers.</strong> Advertisers simply provide an insertion order for the advertising message and Ancestry then displays the ad to appropriate users based on the criteria specified in the order.
</p>

<h4>Does Ancestry request or require any personal financial information?</h4>
<p>
To facilitate payment and fulfillment for membership and purchases at the Ancestry Shop, Ancestry will request personal credit card or debit card information. This information will then be processed by a third party, which manages the payment processing and fulfillment of orders for us. The third party processor will use this information to process and fulfil your orders and to contact you regarding the order. To fulfil your order, your delivery address and your telephone number will also be given to our carriers and, if required by law, to other parties such as Customs and Excise. This will enable our carriers to successfully complete delivery of your order. 
</p>
<p>
...
<h4>Who manages the payment card processing?</h4>
<p>
Third party processors manage payment card processing for us, using software to check for fraudulent use and to link to the banks for credit limits and notification of lost and stolen cards. See "Security."
</p>
<h4>Will Ancestry disclose any of my personal information to third parties?</h4>
<p>
...
<p>
As our business continues to grow, we might buy or sell subsidiaries or business units. In these transactions, customer information is often one of the transferred assets, remaining subject to promises made in existing privacy statements. Also, in the event that The Generations Network, Inc., The Generations Network (Commerce) Limited or substantially all of their assets are acquired, customer information will as a matter of course be one of the transferred assets.
</p>

<h4>Will my information be used for direct mailings?</h4>
<p>
With your  agreement, Ancestry will send electronic mail to you, for the purpose of informing you of changes or additions to Ancestry, or of any Ancestry related products and services. You can also choose to receive promotional offers from trusted Ancestry partners.  If you do not want to continue to receive such mailings, you may opt out at any time by using the unsubscribe link listed in the e-mail or by amending your 'Newsletter and e-mail preferences' in the <strong>'My Account'</strong> section of this site.
</p>
<h4>May I refuse to provide personal information to Ancestry or to accept advertising?</h4>
<p>
...
<h4>Does Ancestry use "IP Addresses" and cookies?</h4>
<p>
...
You can erase or block cookies from your computer if you want to (for further information go to www.aboutcookies.org), but certain Ancestry services may not work correctly or at all if you set your browser not to accept cookies.
</p>
<h4>Advertiser Cookies:</h4>
<p>
We may use third-party advertising companies to serve ads on our behalf. These companies may employ cookies and action tags (also known as single pixel gifs or web beacons) to measure advertising effectiveness. Any information that these third parties collect via cookies and action tags is completely anonymous. If you would like more information about this practice and your choices, <a href="http://www.networkadvertising.org/optout_nonppii.asp">click here.</a>
</p>
<h4>What else should I know about privacy?</h4>
<p>
...
<h4>Public forums - Ancestry Community</h4>
<p>
...
<p>
By using our website and the services you consent to the collection and use of your information by The Generations Network, Inc and The Generations Network (Commerce) Limited. If we decide to change our Privacy Statement, we will post these changes on this page (or send them to you via e-mail or postal mail) so that you will be aware of what information we collect, how we use it and under what circumstances we disclose it in accordance with the Data Protection Act 1998. If you do not consent to any changes to our Privacy Statement and as a result you would like us not to use or hold your information in accordance with the revised terms, you may instruct us to delete your information by sending an e-mail to support@ancestry.co.uk.
</p>
<h4>Contacting the Website</h4>
<p>
If you have any questions about this privacy statement, the practices of this site, or your dealings with this Website, you can contact <a href="mailto:service@ancestryshop.co.uk">service@ancestryshop.co.uk</a> or by writing to:
</p>

<p>
The Generations Network (Commerce) Limited
<br />
