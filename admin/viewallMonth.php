		...
		<form action="checkpass.php" method="post">
			<div align="center">
				...
				<?php
					...
					if( ($CurrentYear==$LastYear)AND($Count<$NumRows-1) )
					{
					...
					{
					//ensure that the last order of the last year is counted
					if($Count==$NumRows-1)
						$NumOrders++;
					?>
						<tr>
							<td align="center"><a href="ordersbyyear.php?passedOrderYear=<?php Escaped_echo($LastYear);?>"><?php Escaped_echo($LastYear);?></a></td>
							<td align="center"><a href="ordersbyyear.php?passedOrderYear=<?php Escaped_echo($LastYear);?>"><?php Escaped_echo($NumOrders);?></a></td>
						</tr>
